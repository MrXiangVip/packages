...
public class MicTest extends Fragment implements  View.OnClickListener{
...
//        return super.onCreateView(inflater, container, savedInstanceState);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        controlBtn = view.findViewById( R.id.recorder_controller );
...
//            finish();
    ...
    public void update_voiceline( ){
        ...
        if( controlBtn.isChecked() && null != mediaRecorder){
