...
import com.mediatek.factorytest.data.DBManager;
import com.mediatek.factorytest.data.DataInterface;
import com.mediatek.factorytest.data.NvramManger;
                ...
                switch (event) {
                    ...
                    case XmlResourceParser.START_TAG:
                        ...
                        if( name.equals( Utils.ITEM ) ){
                            ...
                            String attrName="";
//                            解析出 name , title， action， visible 四个属性
                            String factoryName="";
                            int factoryTitle=0;
    ...
    public static int getPassedBeanSize( ){
        ...
        if( mDatas != null ) {
            ...
            while(it.hasNext()) {
                FactoryBean bean = it.next();
                if(bean.getStatus( ) == Utils.SUCCESS_CODE  ){
                    size ++;
                }
            }
        }
